...
# **************************************
compTrace_file = h5py.File("../Compressed_Traces/Compressed_Traces.hdf5", 'r')  # read
...
file_path = "Best_weights_Original_Traces_256.hdf5"
...
# *   Save the model                *
# ***********************************
model.save("Model_Original_Traces_256.hdf5")


# ***********************************
# *   Close all Open Files           *
# ***********************************
compTrace_file.close()
label_file.close()
