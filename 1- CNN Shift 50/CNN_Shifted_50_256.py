...
# *                                                                     *
# * Purpose: Train a CNN using Shifted traces by 50                     *
# ***********************************************************************
import numpy as np
import h5py
import keras
...
# ***********************************
shifted_traces = h5py.File('shifted_50_Traces.hdf5', 'r')  # read
X_train_original = np.array(shifted_traces.get('S_50_T'))
...
file_path = "Best_weights_Shifted_50.hdf5"
...
# *   Save the model                *
# ***********************************
model.save("Model_Shifted_50.hdf5")


# ***********************************
# *   Close all Open Files           *
# ***********************************
shifted_traces.close()
label_file.close()
