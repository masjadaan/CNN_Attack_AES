...
# *                                                                     *
# * Purpose: Train a CNN using Shifted traces by 100                    *
# ***********************************************************************
import numpy as np
import h5py
import keras
...
# ***********************************
shifted_traces_File = h5py.File('shifted_100_Traces.hdf5', 'r')  # read
X_train_original = np.array(shifted_traces_File.get('S_100_T'))
...
file_path = "Best_weights_Shifted_100.hdf5"
...
# *   Save the model                *
# ***********************************
model.save("Model_Shifted_100.hdf5")
