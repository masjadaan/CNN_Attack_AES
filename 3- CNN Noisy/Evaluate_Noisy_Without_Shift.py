...
# *                                                                     *
# * Purpose: Evaluate the trained model on noisy and without shift      *
# traces by computing accuracy and mean rank                            *
# ***********************************************************************
...
# *****************************************
# * read the Noisy without shifted traces *
# *****************************************
Noisy_File = h5py.File('Noisy_Original_Traces.hdf5', 'r')
...
# **************************************
label_file = h5py.File('Noisy_Labels.hdf5', 'r')  # read
...
# ********************************
Noise_plaintext_file = h5py.File('Noise_Plaintext.hdf5', 'r')  # read
...
# *     read the New Keys   *
# ***************************
Noise_key_file = h5py.File("Noise_Keys.hdf5", 'r')  # read
...
# *****************************************
model = load_model("Model_Noisy_without_Shift.hdf5")
model.load_weights("Best_weights_Noisy_without_Shift.hdf5")
