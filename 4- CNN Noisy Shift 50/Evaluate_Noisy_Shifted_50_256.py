...
# *                                                                     *
# * Purpose: Evaluate the trained model on noisy and shifted            *
...
# *****************************************
Noisy_50_File = h5py.File('Noisy_50_Shifted_Traces.hdf5', 'r')
X_train_original = np.array(Noisy_50_File.get('N_50_S_T'))


# **************************************
# *     read the Noisy Labels          *
# **************************************
label_file = h5py.File('../3- CNN Noisy/Noisy_Labels.hdf5', 'r')  # read
Y_train_original = np.array(label_file.get('N_L'))

print("The original data:")
print("  Noisy 50_shifted shape:", X_train_original.shape)
print("  The Noisy Labels shape:", Y_train_original.shape)
print('********************************\n')


# ********************************
# *     read the New Plaintext   *
# ********************************
Noise_plaintext_file = h5py.File('../3- CNN Noisy/Noise_Plaintext.hdf5', 'r')  # read
Noise_Plaintext = np.array(Noise_plaintext_file.get('N_PT'))
...
# *     read the New Keys   *
# ***************************
Noise_key_file = h5py.File("../3- CNN Noisy/Noise_Keys.hdf5", 'r')  # read
Noise_Keys = np.array(Noise_key_file.get('N_K'))
print("New Keys shape:", Noise_Keys.shape)
print('********************************\n')
...
# **************************************
Plaintext = Noise_Plaintext[testDataLowerLimit:testDataUpperLimit]
print("Test plaintext shape: ", Plaintext.shape)
print('********************************\n')
...
# *     divide the Keys                *
# **************************************
keys = Noise_Keys[testDataLowerLimit:testDataUpperLimit]
print("Test key shape: ", keys.shape)
print('********************************\n')
...
# *****************************************
model = load_model("Model_Noisy_Shifted_50.hdf5")
model.load_weights("Best_weights_Noisy_Shifted_50.hdf5")
...
# print(np.argmax(prediction[6]))  # position of largest peak is the label number
# print(np.argmax(Y_train_original[6]))
...
# for i in range(9):
#     print('Key Guesses of trace %d ' % i)
#     for j in range(7):
#         print('', key_Guesses[i][j], end=' ')
#
#     print('\n')
