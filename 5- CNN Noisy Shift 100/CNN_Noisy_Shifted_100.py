...
# *                                                                     *
# * Purpose: Train a CNN using Noisy and shifted traces by 100          *
# ***********************************************************************
import numpy as np
import h5py
import keras
...
def ArchModel(input_width, input_height, filter_width, filter_height, depth, number_classes):
    ...
    :param int stride_width : Sliding step along the width of input.
    :param int stride_height: Sliding step along the height of input.
    ...
    block_2_filters = 16
    # Conv
    model.add(Conv2D(block_2_filters, kernel_size=(filterHeight, filterWidth), padding='same',
                     data_format="channels_last", activation=Act, use_bias=True))
    # ----------------------------------------------------------------------------------------------------------------------
    ...
    block_3_filters = 32
    # Conv
    model.add(Conv2D(block_3_filters, kernel_size=(filterHeight, filterWidth), padding='same',
                    data_format="channels_last", activation=Act, use_bias=True))
    # ----------------------------------------------------------------------------------------------------------------------
...
file_path = "Best_weights_Noisy_Shifted_100.hdf5"
...
# *   Save the model                *
# ***********************************
model.save("Model_Noisy_Shifted_100.hdf5")
