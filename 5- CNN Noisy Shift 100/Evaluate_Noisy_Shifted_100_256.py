...
# traces by 100 by computing accuracy and mean rank                     *
# ***********************************************************************
...
# *****************************************
Noisy_100_File = h5py.File('Noisy_100_Shifted_Traces.hdf5', 'r')
X_train_original = np.array(Noisy_100_File.get('N_100_S_T'))
...
print("  Noisy 100_shifted shape:", X_train_original.shape)
...
# *****************************************
model = load_model("Model_Noisy_Shifted_100.hdf5")
model.load_weights("Best_weights_Noisy_Shifted_100.hdf5")
