...
# *                                                                     *
# * Purpose: it Evaluates the trained model by computing accuracy       *
# * and mean rank                                                       *
# ***********************************************************************
...
# *****************************************
model = load_model("Model_Augmented.hdf5")
model.load_weights("Best_weights_Augmented.hdf5")
...
# ***************************************
# activation_map = get_activations(model, x_Test[11:12], print_shape_only=True)  # with just one sample.
